...
NOTA BENE: PUNTA AD AVERE UN APPLICATIVO FUNZIONANTE, FACILE DA FAR STARTARE PER POTER PRESENTARE DEMO ALLA FINE DI SVILUPPI CON AI, CON POCHE CONFIGURAZIONI CHE SI DEVONO FARE CUSTOM E SENZA DATABASE PER POTER FAR GIRARE TUTTO E FAR SEMBRARE CHE TUTTO FUNZIONI ALLA PERFEZIONE. NELLA SCRITTURA DI TUTTE LE EPICHE, STORIE TASK E NELLO SVILUPPO POI DI QUESTI TIENI SEMPRE IN CONSIDERAZIONE QUESTO: PUNTIAMO SULL'EFFETTO WOW, SIAMO VELOCI E CONCENTRIAMOCI SULLE COSE IMPORTANTI MA SENZA DILUNGARCI A FARE COSE TROPPO COMPLESSI. PAROLA CHIAVE: EFFICACIA ED EFFICIENZA.
